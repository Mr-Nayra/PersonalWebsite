...
export function AtomBackground({ className }: { className?: string } = {}) {
  return (
    <div className={cn("absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] lg:w-[1200px] lg:h-[1200px] pointer-events-none opacity-60 dark:opacity-30 select-none flex items-center justify-center z-0", className)}>
      {/* Nucleus */}
      <div className="absolute w-12 h-12 md:w-16 md:h-16 lg:w-24 lg:h-24 bg-slate-400/40 dark:bg-gray-500/20 rounded-full blur-[8px]" />
      <div className="absolute w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 bg-slate-500 dark:bg-gray-600 rounded-full shadow-[0_0_30px_rgba(100,116,139,0.8)]" />

      {/* Orbit 1 */}
      <div className="absolute w-[20%] h-[20%] border-[1px] border-slate-400 dark:border-slate-600 rounded-full">
      ...
      {/* Orbit 2 */}
      <div className="absolute w-[36%] h-[36%] border-[1px] border-slate-400 dark:border-slate-600 rounded-full">
      ...
      {/* Orbit 3 */}
      <div className="absolute w-[52%] h-[52%] border-[1px] border-slate-400 dark:border-slate-600 rounded-full">
      ...
      {/* Orbit 4 */}
      <div className="absolute w-[68%] h-[68%] border-[1px] border-slate-400 dark:border-slate-600 rounded-full">
      ...
      {/* Orbit 5 */}
      <div className="absolute w-[84%] h-[84%] border-[1px] border-slate-400 dark:border-slate-600 rounded-full">
